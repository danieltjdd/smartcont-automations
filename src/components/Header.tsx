    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container-custom py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#solucoes" className="text-gray-600 hover:text-smartcont-600 font-medium transition-colors">
            Soluções
          </a>
          <a href="#precos" className="text-gray-600 hover:text-smartcont-600 font-medium transition-colors">
            Preços
          </a>
          <a href="#contato" className="text-gray-600 hover:text-smartcont-600 font-medium transition-colors">
            Contato
          </a>
          <Link to="/login">
