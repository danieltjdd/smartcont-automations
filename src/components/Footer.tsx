        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/precos" className="text-smartcont-100 hover:text-white transition-colors">
                  Preços
                </Link>
              </li>
              <li>
                <Link to="/contato" className="text-smartcont-100 hover:text-white transition-colors">
                  Contato
                </Link>
              </li>
            </ul>
