...
const recentActivity = [
  {
    title: "Conferência PIS/COFINS concluída",
    description: "Arquivo: relatorio_marco_2024.xlsx",
    time: "2 horas atrás",
    status: "Concluído",
  ...
  {
    title: "Conferência NCM iniciada",
    description: "Arquivo: produtos_abril_2024.csv", 
    time: "4 horas atrás",
    status: "Em andamento",
  ...
  },
  {
    ...
    description: "Conferência de escrituração",
    time: "1 dia atrás",
    status: "Concluído",
    statusColor: "bg-green-100 text-green-800",
    icon: FileText,
